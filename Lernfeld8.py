...
def modul_lernen_und_testen(modulname, lerninhalte, fragen, video_url=None):
    def video():
        if not video_url:
            print("Für dieses Modul ist kein Video verfügbar.")
            return
        print(f"\nÖffne YouTube-Video für Modul: {modulname}")
        webbrowser.open(video_url)
        input("Drücke Enter, sobald du das Video gesehen hast...")
    def lernen():
        print(f"\nLERNMODUS - {modulname}\n")
...
def modul81():
    ...
    modul_lernen_und_testen("Lernfeld 8: modul1 Projektmanagement",lerninhalte,fragen,video_url="https://www.youtube.com/watch?v=QtWh1TfzOAE")
...
def modul82():
    ...
    modul_lernen_und_testen("Datenquellen?", lerninhalte, fragen, video_url="https://www.youtube.com/watch?v=2qlcY9LkFik")
...
def modul83():
    lerninhalte = [
        ...
        "Kanban ist eine agile Projektmanagementmethode, bei der eine Gesamtaufgabe in einzelne Schritte zerlegt und\n\
        diese einzeln abgearbeitet werden.\n\
        ...
        "Ein Kanban-Board visualisiert den Bearbeitungsstand von Aufgaben – typischerweise in drei Spalten: To Do,\n\
        ...
        "Vorteile von Kanban: Übersicht über Fortschritt und Probleme, schnelle Bearbeitung, geringer Managementaufwand, vielseitig\n\
        einsetzbar, gute Kombinierbarkeit mit anderen Methoden.\n\
        Nachteile: Hohe Anforderungen an Teamkompetenz, nur bedingt geeignet für große Projekte oder starres Zeitmanagement.",

        "Im Vergleich zu Scrum: Kanban ist flexibler, hat wenige feste Regeln, keine festen Rollen und Iterationen sind optional.\n\
        Scrum hingegen hat ein komplexes Regelwerk, feste Rollen (Product Owner, Scrum Master, Team), sowie vorgeschriebene Iterationen\n\
        und Priorisierung.\n\
        Kanban eignet sich auch für Routineaufgaben, während Scrum nur für Projekte ab drei Personen geeignet ist.",

        "Obwohl beide Methoden Gemeinsamkeiten wie agile Arbeitsweise, transparente Prozesse und Aufgabenverteilung aus einem\n\
        Backlog aufweisen, bleibt Scrum das umfassendere Modell.\n\
        Kanban lässt sich leicht auf die visuelle Darstellung von Aufgabenmanagement reduzieren und flexibel mit anderen Methoden\n\
        kombinieren."
    ]
    ...
    fragen = [
        ...
        {
            "frage": "Welche Gemeinsamkeit haben Kanban und Scrum?",
    ...
    modul_lernen_und_testen("Agile Vorgehensmodelle", lerninhalte, fragen,video_url="https://www.youtube.com/watch?v=SWDhGSZNF9M")
